...
public class JavaReflectUtil {
    ...
    public static List<Map<String, Object>> getAllFiledInfo(Object o) {
        ...
        List<Map<String, Object>> allFiledInfos = new ArrayList<Map<String,Object>>();
        for (int i = 0; i < attributes.length; i++) {
            Map<String, Object> allFiledInfo = new HashMap<String, Object>();
